...
// Etiquetas visibles para cada filtro; el valor interno no cambia.
const STATUS_FILTER_LABELS: Record<string, string> = {
  ALL: "Todos",
  SENT: "Enviados",
  FAILED: "Fallidos",
  PENDING: "Pendientes",
  SKIPPED_RATE_LIMIT: "Límite de tasa",
  SKIPPED_PLAN_LIMIT: "Límite de plan",
          ...
          <table className="w-full min-w-[760px] text-sm">
            <thead>
              <tr className="border-b border-border text-left">
                ...
                <th className="px-4 py-4 text-xs font-semibold text-muted uppercase tracking-wider sm:px-6">Hora</th>
              </tr>
            </thead>
