    ...
    try {
      const res = await fetch("/api/automations", {
        ...
        body: JSON.stringify({
          ...
          secondaryButtonLabel: auto.trackedLinks[1]?.label ?? "Abrir enlace",
        ...
        <div>
          <p className="text-sm text-muted">
            ...
            {filtered.length !== automations.length
              ...
              : ""}{" "}
            {automations.length !== 1 ? "campañas" : "campaña"}
          </p>
        </div>
      ...
      {automations.length > 0 && (
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
          <input
            ...
            placeholder="Busca campañas por nombre, palabra o mensaje…"
              ...
              >
                ...
                {auto.postUrl && (
                  <button
                    ...
                    className="shrink-0 rounded-full border border-border px-3 py-2 text-xs font-medium text-muted transition-colors hover:border-border-hover hover:text-foreground"
                  >
                ...
                <div className="relative">
                  <button
                    ...
                    className="px-2.5 py-2 min-w-[40px] rounded text-lg leading-none text-muted hover:text-foreground"
                  >
                    ⋯
                  </button>
                  {menuOpenId === auto.id && (
