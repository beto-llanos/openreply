  ...
  return (
    ...
    >
      <div className="flex min-w-0 items-center gap-3 sm:gap-4">
        <button
          onClick={onMenuClick}
          className="lg:hidden shrink-0 px-3 py-2 min-h-[40px] rounded border border-border text-sm text-muted hover:text-foreground"
      ...
      {instagramAccountCount > 0 ? (
        ...
        <a
          ...
          className="shrink-0 whitespace-nowrap text-sm font-medium px-3 py-2 rounded bg-accent text-white hover:bg-accent-hover"
        >
